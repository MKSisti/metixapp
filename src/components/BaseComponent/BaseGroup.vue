<template>
  <div class="flex justify-start items-center flex-col w-full relative">
    ...
    <div
      ...
      class="cursor-pointer flex justify-between items-center flex-row w-full h-20 p-4 z-10"
    >
    ...
    <div
      ...
      ref="groupChildren"
      class="w-full justify-start items-start transition-all duration-200 transform-gpu relative z-0 overflow-hidden"
    >
      <!-- new module -->
      <div class="relative w-full">
        ...
        <transition @before-leave="beforeLeave" name="fade" appear>
          <div
            v-if="expanded && AddModuleVisible"
