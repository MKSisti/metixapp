  ...
  <base-body :key="GroupId" class="capitalize overflow-hidden">
    ...
    <template v-slot:topRight>
      <div class="space-y-2 pt-4 w-full flex justify-center items-end flex-col">
        <div
          class="bg-blue-base px-4 py-2 text-xl text-black-base cursor-pointer flex justify-center items-center w-36 hover:w-40 transition-all duration-200"
        >
        ...
        <div
          class="bg-blue-base px-4 py-2 text-xl text-black-base cursor-pointer w-36 hover:w-40 transition-all duration-200"
        >
          Edit Group
        </div>
      </div>
    ...
    <template v-slot:content>
      ...
      >
        ...
        <div
          v-if="ShowAddStudent"
          class="bg-black-light-1 flex justify-between items-center flex-col w-full h-64 relative pb-1 flex-none"
        >
          ...
          <div class="flex justify-center items-center flex-row cursor-pointer">
            <button
              @click="addNewSt"
              class="capitalize rounded-none bg-blue-base px-6 py-1.5 text-xl font-semibold text-black-base hover:bg-blue-light-1 transition duration-200"
            >
              done
            </button>
          </div>
